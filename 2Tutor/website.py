...
from wtforms import StringField, SubmitField, PasswordField, IntegerField, EmailField, FileField, BooleanField
...
class ReviewView(MethodView): #I probably fucked it up, need to check
